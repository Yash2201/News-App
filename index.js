//  API KEY :- Set the API Where apiKey Variable Defined... 
...
{
    document.getElementById("showError").innerHTML = `<b style="color: red"> Please Set The API Key AT JavaScript To Get Latest News</b>`;
}
